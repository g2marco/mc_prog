...
gcc $MAIN_PATH/pic16fxxx_programmer.c $MODULES_PATH/erase_device.c $MODULES_PATH/program_pic16f.c $MODULES_PATH/program_info.c $MODULES_PATH/driver_pic16f.c $MODULES_PATH/port_adapter.c $MODULES_PATH/parallel_port.c -o $TARGET_PATH $INCLUDE_LIBS 
